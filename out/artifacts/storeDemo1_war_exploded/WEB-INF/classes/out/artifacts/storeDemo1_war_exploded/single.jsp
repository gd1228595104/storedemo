        ...
        <div class="col-md-8 single-right">
            <div class="col-md-5 single-right-left animated wow slideInUp" data-wow-delay=".5s">
                <div class="flexslider">
                    <ul class="slides">
                        <li data-thumb="<%=goods.getFileadress()%>">
                            <div class="thumb-image"> <img src="<%=goods.getFileadress()%>" data-imagezoom="true" class="img-responsive"> </div>
                        </li>
                        <li data-thumb="<%=goods.getFileadress()%>">
                            <div class="thumb-image"> <img src="<%=goods.getFileadress()%>" data-imagezoom="true" class="img-responsive"> </div>
                        </li>
            ...
            <div class="col-md-7 single-right-left simpleCart_shelfItem animated wow slideInRight" data-wow-delay=".5s">
                ...
                <h4><span class="item_price">¥<%=goods.getPrice()%></span></h4>
                <div class="rating1">
               ...
               <%-- <div class="color-quality">
                ...
                <div class="occasional">
                    <h5>商品信息</h5>
                    <div class="colr ert">
                        <label class="radio"><input type="radio" name="radio" checked=""><i></i>商品信息（数据库）</label>
                    </div>
                    <div class="colr">
                        <label class="radio"><input type="radio" name="radio"><i></i>商品信息(数据库)</label>
                    </div>
                    <div class="colr">
                        <label class="radio"><input type="radio" name="radio"><i></i>商品信息（数据库)</label>
                    </div>
                ...
                <div class="occasion-cart">
                    <a class="item_add" href="CheckoutAction.action?name=<%=goods.getGoods_name()%>">加入购物车</a>
                </div>
                <div class="social">
