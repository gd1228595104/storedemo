        ...
        <div class="header-grid">
            <div class="header-grid-left animated wow slideInLeft" data-wow-delay=".5s">
                <ul>
                    ...
                    <li class="active"><i class="glyphicon glyphicon-log-in" aria-hidden="true"></i><a href="login.jsp">登录</a></li>
...
<div class="login">
    <div class="container">
        ...
        <p class="animated wow slideInUp" data-wow-delay=".5s"><a href="register.jsp">在这里注册</a> 或返回 <a href="index.html">首页<span class="glyphicon glyphicon-menu-right" aria-hidden="true"></span></a></p>
    </div>
</div>
<!-- //login -->
<!-- footer -->
