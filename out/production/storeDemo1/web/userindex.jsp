...
<head>
    ...
    <script type="text/javascript">
        ...
        function loadMenu(resourceType, treeObj){
            /*$.ajax({
                type:"POST",
                url:"/authority/modelPart.action?resourceType=" + resourceType,
				dataType : "json",
            ...
            data = [{"accessPath":"","checked":false,"delFlag":0,"parentID":1,"resourceCode":"","resourceDesc":"","resourceGrade":2,"resourceID":3,"resourceName":"基础数据","resourceOrder":0,"resourceType":""},
                {"accessPath":"adminAllGoodsAction.action","checked":false,"delFlag":0,"parentID":3,"resourceCode":"","resourceDesc":"","resourceGrade":3,"resourceID":7,"resourceName":"商品信息","resourceOrder":0,"resourceType":""},
                {"accessPath":"ShowOrderInfoAction2.action","checked":false,"delFlag":0,"parentID":3,"resourceCode":"","resourceDesc":"","resourceGrade":3,"resourceID":8,"resourceName":"订单信息","resourceOrder":0,"resourceType":""},
                {"accessPath":"ShowAllCustomerAction3.action","checked":false,"delFlag":0,"parentID":3,"resourceCode":"","resourceDesc":"","resourceGrade":3,"resourceID":9,"resourceName":"用户信息","resourceOrder":0,"resourceType":""}];
        ...
        <div id="top_op">
            <ul>
                <li>
                    ...
                    <span><%=(String)session.getAttribute("admin")%></span>
                </li>
                <li>
